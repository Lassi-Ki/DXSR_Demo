...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    try
    {
        ...
        // 创建 DirectSR SRDevice设备，创建超分辨率引擎时要提前创建好资源描述符SRV+UAV
        {
        ...
        // 使用WIC创建并加载一个2D纹理
        {
            ...
            motionVectorTextureDesc.Format = DXGI_FORMAT_R16G16_FLOAT; // 运动矢量的格式
            motionVectorTextureDesc.Width = nTextureW; // 纹理宽度
            motionVectorTextureDesc.Height = nTextureH; // 纹理高度
            ...
            motionVectorTextureDesc.Flags = D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS; // 允许无序访问
            ...
            hsr = pID3D12Device4->CreateCommittedResource(
                &stHeapProp
                , D3D12_HEAP_FLAG_NONE
                , &stTargetTextureDesc				//可以使用CD3DX12_RESOURCE_DESC::Tex2D来简化结构体的初始化
                , D3D12_RESOURCE_STATE_COMMON
                , nullptr
